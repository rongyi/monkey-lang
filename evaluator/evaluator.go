...
func Eval(node ast.Node, env *object.Environment) object.Object {
	...
	case *ast.IfExpression:
		// fmt.Println("if expression exec...")
...
func evalProgram(prog *ast.Program, env *object.Environment) object.Object {
	...
	for _, curStmt := range prog.Statements {
		ret = Eval(curStmt, env)
		...
		// if rv, ok := ret.(*object.ReturnValue); ok {
		// 	return rv.Value
		// }
	}
...
func extendFunctionEnv(fn *object.Function, args []object.Object) *object.Environment {
	...
	for pararIndex, param := range fn.Parameters {
		env.Set(param.Value, args[pararIndex])
	}
	return env
}
...
func evalIndexExpression(left, index object.Object) object.Object {
	...
	default:
		return newError("index oprator not supported: %s", left.Type())
	}
}
