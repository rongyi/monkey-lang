...
// NOTE: this function is not very functional, there is a side effect in it
...
func (p *Parser) parseExpression(precedence int) ast.Expression {
	...
	// when next operator is higher than "current", recursive in the expression
