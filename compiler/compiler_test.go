...
func TestCompilerScopes(t *testing.T) {
	...
	globalSymbloTable := compiler.symbolTable
	...
	if compiler.symbolTable.Outer != globalSymbloTable {
	...
	if compiler.symbolTable != globalSymbloTable {
